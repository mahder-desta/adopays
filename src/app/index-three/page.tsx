...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative pt-24 xl:pb-[420px] md:pb-80 pb-36 items-center overflow-hidden bg-primary bg-center bg-no-repeat bg-cover"
        id="home"
        ...
        <div className="container relative">
          <div className="grid grid-cols-1 justify-center">
            <div className="relative z-2 duration-500 xl:-mt-[400px] lg:-mt-[320px] md:-mt-[350px] -mt-[140px] m-0">
              <Image
                src="/images/phone/3-phone-full.png"
                width={0}
                height={0}
                sizes="100vw"
