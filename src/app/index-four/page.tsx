...
export default function Page() {
  return (
    <>
      ...
      <section
        className="relative table w-full py-24 overflow-hidden"
        id="home"
      >
          ...
          <div className="relative grid md:grid-cols-12 grid-cols-1 items-center mt-10 gap-[30px]">
            <div className="md:col-span-6">
              <div className="md:me-6">
                <h6 className="text-sm font-bold tracking-wider mb-3">
                  #No1 Trending Apps On Play Store
                </h6>
                <h4 className="font-bold lg:leading-normal leading-normal text-4xl lg:text-[54px] mb-5">
                  Landing Page For <br /> Showcase App
                </h4>
            ...
            <div className="md:col-span-6">
              <div
                className="relative after:content-[''] after:absolute after:md:bottom-48 after:-bottom-20 lg:after:-start-10 md:after:-start-20 after:-start-24
                        after:bg-primary after:shadow-2xl after:shadow-primary/40 after:z-1 ltr:after:rotate-[130deg] rtl:after:-rotate-[130deg] after:w-[75rem] after:md:h-[45rem] after:h-[30rem] after:rounded-[30rem]"
              >
                <Image
                  ...
                  className="lg:max-w-[600px] md:max-w-md relative z-2 mover"
                  alt=""
                />
              </div>
            </div>
