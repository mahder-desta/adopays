  ...
  let data: Data[] = [
    {
      ...
      desc: "Our platform employs advanced encryption and two-factor authentication to safeguard your data and transactions.",
    },
    {
      icon: FiAperture,
      title: "High Performance",
      desc: "Our platform is designed to handle high volumes of transactions efficiently, ensuring swift processing without delays.",
    },
  ];
  return (
      ...
      <div className="lg:col-span-7 md:col-span-6">
        <div className="lg:ms-10">
          ...
          <h4 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-bold">
            Secure Transactions <br /> & Real-Time Updates
          </h4>
          <p className="text-slate-400 max-w-xl">
            Experience next-generation banking with our feature-rich solution
            that puts financial control right at your fingertips.
          </p>
