...
export default function Page() {
  ...
  return (
    <>
      ...
      <section
        className="relative pt-24 xl:pb-[420px] md:pb-80 pb-36 items-center overflow-hidden bg-primary/5"
        id="home"
      >
        <div
        ...
        <div className="container relative ">
          <div className="grid grid-cols-1 justify-center">
            <div className="relative z-2 duration-500 xl:-mt-[400px] lg:-mt-[320px] md:-mt-[350px] -mt-[140px] m-0">
              ...
              <div className="absolute overflow-hidden lg:size-[600px] md:size-[450px] sm:size-[400px] size-[320px] bg-gradient-to-tl to-primary/20 via-primary/70 from-primary bottom-0 translate-x-1/2 start-1/2 ltr:-translate-x-1/2 rtl:md:translate-x-0 rtl:translate-x-1/2 z-1 shadow-md shadow-primary/10 rounded-full"></div>
            </div>
          </div>
        </div>
      </section>
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 mt-6">
                  {aboutData.map((item: any, index: number) => {
                    ...
                    return (
                      <ReactWOW animation="fadeInUp" key={index}>
                        <div
                          className="group flex relative overflow-hidden p-6 rounded-md shadow dark:shadow-gray-800 bg-slate-50/50 dark:bg-slate-800/20 hover:bg-primary dark:hover:bg-primary duration-500 wow animate__animated animate__fadeInUp"
                          data-wow-delay=".3s"
                          key={index}
                        >
